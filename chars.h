...
//         "<format front=red >     ;;;;;    ;     </format>",
//         "<format front=red >     ;;;;; ;;;      </format>",
//         "<format front=red >     ;;;;; jj;      </format>",
//         "<format front=red >    :::::::;j;      </format>",
//         "<format front=red >     :::;;;         </format>",
//         "<format front=red >     ;;;;;;         </format>"};
...
//         "<format front=blue >     jj;;jjj;;jj    </format>",
//         "<format front=blue >     jjjjjjjjjjj    </format>",
//         "<format front=blue >     jjj;;;,;;jj    </format>",
//         "<format front=blue >      jjjjjjjjjj    </format>",
...
//         "<format front=green >    EiijEjiiE   ,   </format>",
//         "<format front=green >     EEiiiE    E    </format>",
//         "<format front=green >       EEKKEEEE     </format>",
//         "<format front=green >       EiEEEEEE     </format>",
...
//         "<format front=red >      :::::::::     </format>",
//         "<format front=red >     :::::::::::    </format>",
//         "<format front=red >     t  :E.E:  t    </format>",
//         "<format front=red >        ::.::       </format>",
//         "<format front=red >     ::::....:::    </format>",
//         "<format front=red >     :::. : ::::    </format>"};
...
//         "<format front=green >   ;;;;;;;;;;;,;    </format>",
//         "<format front=green >   ;,,;,;;;,;,,;    </format>",
//         "<format front=green >   ttt;;;;;;;ttt    </format>",
//         "<format front=green >      ;;;;;;;       </format>",
//         "<format front=green >        EEEEE;EEEE  </format>",
