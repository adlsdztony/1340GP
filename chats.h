...
const map<string, vector<string>> chat_map = {
	...
	"so make sure to choose the right one. And don't forget to stock up on plenty of Pokeballs before you head out on your journey! Good luck catching them all!",
        "Did you know that there are other Pokemon players out there just like you? You can challenge them to battles and test your skills against theirs.",
	"There are also Pokemon tournaments held in different sites,",
    ...
    {"Siki", {
        "Ah, you want to challenge me, trainer? I'm always up for a good battle. But be warned, I won't go easy on you just because we're chatting.", 
	"My Pokemon and I are always ready for a challenge. Are you sure you're ready to face us? If so, let's battle and see who comes out!"
        }
    },
    {"Peter", {
        "Hey, trainer! I see you've been training your Pokemon hard. I think it's time we put your skills to the test.", 
	"Let's have a friendly battle and see how you fare against me. Don't worry, it'll be a good learning experience for both of us!"
        }
    },
    {"Daniel", {
        "Hello, young trainer. I've been watching you from afar and I must say, I'm impressed with your progress. You've come a long way since you started your journey. But don't get too confident.",
	"There's always room for improvement. Let me give you a challenge and see if you're truly ready for what lies ahead."
        }
    },
    {"Tony", {
        "Greetings, fellow Pokemon enthusiast! I can see the passion for Pokemon in your eyes. It's always refreshing to meet someone who shares the same love for these creatures as I do.",
	"Let's have a friendly battle and see how we match up. And afterward, we can chat more about our favorite Pokemon and strategies. What do you say?"
        }
    },
    {"recovery_center", {
